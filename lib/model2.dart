...
//
//     final popUpData = popUpDataFromJson(jsonString);

import 'dart:convert';

PopUpData popUpDataFromJson(String str) => PopUpData.fromJson(json.decode(str));

String popUpDataToJson(PopUpData data) => json.encode(data.toJson());
